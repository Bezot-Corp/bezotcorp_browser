...
impl NavigationState {
    ...
    pub(crate) fn navigate_to(&mut self, url: impl Into<String>) -> &str {
        ...
        self.history.push(NavigationEntry::new(url.clone()));
    ...
    pub(crate) fn apply_command(&mut self, command: NavigationCommand) -> Option<&str> {
        match command {
            ...
            NavigationCommand::Stop => None,
            NavigationCommand::Home => Some(self.navigate_to(HOME_URL)),
        }
    }
